    ...
    <>
      <main className="overflow-x-scroll sm:p-[0_1rem]  md:p-[10px] md:mt-6">
        ...
        <div className="mt-8">
          ...
          <table className="bg-colorWhite dark:bg-colorWhite_DM w-full border-separate table-auto rounded-3xl p-[1.5rem] text-center shadow-md shadow-colorInfoLight dark:shadow-colorBackground_DM hover:ring-1 dark:hover:ring-colorLight  ring-slate-300 hover:shadow-none transition-shadow duration-300 ease">
            <thead>
              <tr>
