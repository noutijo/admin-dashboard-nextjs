...
export default function CardItem({
  ...
  return (
    <>
      <div className="bg-colorWhite dark:bg-colorWhite_DM rounded-3xl mt-4 transition-shadow duration-300 ease shadow-md shadow-colorInfoLight dark:shadow-colorBackground_DM hover:ring-1 dark:hover:ring-colorLight  ring-slate-300 hover:shadow-none p-7 overflow-auto">
        <i
